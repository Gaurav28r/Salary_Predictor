...
## Features
* **Exploratory Data Analysis (EDA):** Visualized salary trends and outliers using Matplotlib and Seaborn.
* **Model Comparison:** Evaluated Linear Regression vs. Random Forest Regressor to ensure the highest prediction accuracy.
* **Interactive UI:** Deployed a user-friendly prediction form utilizing Streamlit.
